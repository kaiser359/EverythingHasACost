...
public class RotateToMouse : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float angleDifference = Mathf.Abs(Mathf.DeltaAngle(transform.rotation.eulerAngles.z, angle));
        transform.rotation = Quaternion.RotateTowards(transform.rotation, target, rotationSpeed * Time.deltaTime * angleDifference * 0.01f);
    }
}
